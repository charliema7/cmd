class ConversationsController < ApplicationController
  ...
  before_action :set_opt_out_participants, only: [:show, :add_participant, :opt_out]
  ...
  def show
    ...
    @users = User.all - conversation.participants - @opted_out_participants
