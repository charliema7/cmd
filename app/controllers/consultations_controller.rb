class ConsultationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @consultation.save
        format.html { redirect_to consultations_path, notice: 'Consultation was successfully created.' }
  ...
  private
    ...
    def consultation_params
      params.require(:consultation).permit(:user_id, :description, :started_at, :ended_at)
    end
end
